...
test.describe('Portal de Vagas', () => {
  test('login and open profile modal', async ({ page }) => {
    ...
    const loginUrl = `/PortalVagas/Acesso?tenantId=${encodeURIComponent(tenant)}&returnUrl=%2FPortalVagas`;
    ...
    // Após clicar, o JS faz POST para /PortalVagas/Auth/Login e redireciona.
    // Esperamos ou o redirecionamento, ou um SweetAlert de erro.
    const navigationPromise = page.waitForURL('**/PortalVagas', { timeout: 15000 });
