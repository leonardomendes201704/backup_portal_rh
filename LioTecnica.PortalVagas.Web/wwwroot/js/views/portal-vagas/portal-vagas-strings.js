(function () {
  ...
  window.PortalVagasStrings = {
    ...
    jobs: {
      ...
      retrying: "Conectando ao portal de vagas... nova tentativa em alguns segundos.",
      retryingAttempt: "Conectando ao portal de vagas... tentativa {current} de {total}.",
      unavailableTitle: "Portal temporariamente indisponível",
      unavailableMessage: "Não foi possível carregar as vagas agora. Tente novamente mais tarde.",
